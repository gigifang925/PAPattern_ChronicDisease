%include '/udd/hpzfa/review/PA/lag/second/db/hpfs.doloop8.sas';
%include '/udd/hpzfa/review/PA/lag/second/db/nhs.doloop8.sas';
%include '/udd/hpzfa/review/PA/lag/second/db/nhs2.doloop8.sas';
...
%mphreg9(data=pooldata, event=type2dbv, qret=irt94 irt96 irt98 irt00 irt02 irt04 irt06 irt08 irt10 irt12 irt14 irt16 irt18,

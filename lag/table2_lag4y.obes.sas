%include '/udd/hpzfa/review/PA/lag/second/obes/hpfs.doloop4.sas';
%include '/udd/hpzfa/review/PA/lag/second/obes/nhs.doloop4.sas';
%include '/udd/hpzfa/review/PA/lag/second/obes/nhs2.doloop4.sas';
...
%mphreg9(data=pooldata, event=obes_cav, qret=irt90 irt92 irt94 irt96 irt98 irt00 irt02 irt04 irt06 irt08 irt10 irt12 irt14 irt16 irt18,
         timevar=t90 t92 t94 t96 t98 t00 t02 t04 t06 t08 t10 t12 t14 t16 t18,
         id=id, labels=f,
         tvar=interval_b,
         agevar=agemos,
         strata=agemos interval_b cohort, 
         cutoff=cutoff,
         dtdx=dt_obesca, dtdth=dtdth, outdat=result,
	model1 =act_med15  ,

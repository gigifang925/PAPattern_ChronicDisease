...
%pre_pm(data=pooldata, out=table, timevar=interval_b,
        ...
        cutoff= cutoff, dtdx=dt_obesca, dtdth=dtdth,
        case=obes_cav, var=actq);
%pm(data=table, case=obes_cav, exposure=actq, ref=0);

%pre_pm(data=pooldata, out=table, timevar=interval_b,
        irt= irt86 irt88 irt90 irt92 irt94 irt96 irt98 irt00 irt02 irt04 irt06 irt08 irt10 irt12 irt14 irt16 irt18, 
        cutoff= cutoff, dtdx=dt_obesca, dtdth=dtdth,
        case=obes_cav, var=sustainq);
%pm(data=table, case=obes_cav, exposure=sustainq, ref=0);

%pre_pm(data=pooldata, out=table, timevar=interval_b,
        irt= irt86 irt88 irt90 irt92 irt94 irt96 irt98 irt00 irt02 irt04 irt06 irt08 irt10 irt12 irt14 irt16 irt18, 
        cutoff= cutoff, dtdx=dt_obesca, dtdth=dtdth,
        case=obes_cav, var=percdurquar);
%pm(data=table, case=obes_cav, exposure=percdurquar, ref=0);

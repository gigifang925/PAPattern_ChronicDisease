* * * * * * * * * * * * * * * * * * * * * * * * * * * * *
*      PA TRAJECTORY AT 40-60 - Identify 4 groups       *
* * * * * * * * * * * * * * * * * * * * * * * * * * * * *;
...
PROC TRAJ DATA=pool_traj OUT=OF_4 OUTPLOT=OP_4 OUTSTAT=OS_4 OUTEST=OE_4 ITDETAIL;
    ID id; VAR act_40 act_44 act_48 act_52 act_56 act_60; INDEP age_40 age_44 age_48 age_52 age_56 age_60;
    MODEL CNORM; MAX 100; NGROUPS 4; ORDER 2 3 3 3 ;
RUN;

PROC TRAJ DATA=pool_traj OUT=OF_4 OUTPLOT=OP_4 OUTSTAT=OS_4 OUTEST=OE_4 ITDETAIL;
    ID id; VAR act_40 act_44 act_48 act_52 act_56 act_60; INDEP age_40 age_44 age_48 age_52 age_56 age_60;
    MODEL CNORM; MAX 100; NGROUPS 4; ORDER 1 3 3 3 ;
RUN;

PROC TRAJ DATA=pool_traj OUT=OF_4 OUTPLOT=OP_4 OUTSTAT=OS_4 OUTEST=OE_4 ITDETAIL;
    ID id; VAR act_40 act_44 act_48 act_52 act_56 act_60; INDEP age_40 age_44 age_48 age_52 age_56 age_60;
    MODEL CNORM; MAX 100; NGROUPS 4; ORDER 2 2 3 3 ;
RUN;

PROC TRAJ DATA=pool_traj OUT=OF_4 OUTPLOT=OP_4 OUTSTAT=OS_4 OUTEST=OE_4 ITDETAIL;
    ID id; VAR act_40 act_44 act_48 act_52 act_56 act_60; INDEP age_40 age_44 age_48 age_52 age_56 age_60;
    MODEL CNORM; MAX 100; NGROUPS 4; ORDER 1 2 3 3 ;
RUN;

PROC TRAJ DATA=pool_traj OUT=OF_4 OUTPLOT=OP_4 OUTSTAT=OS_4 OUTEST=OE_4 ITDETAIL;
    ID id; VAR act_40 act_44 act_48 act_52 act_56 act_60; INDEP age_40 age_44 age_48 age_52 age_56 age_60;
    MODEL CNORM; MAX 100; NGROUPS 4; ORDER 1 1 3 3 ;
RUN;

PROC TRAJ DATA=pool_traj OUT=OF_4 OUTPLOT=OP_4 OUTSTAT=OS_4 OUTEST=OE_4 ITDETAIL;
    ID id; VAR act_40 act_44 act_48 act_52 act_56 act_60; INDEP age_40 age_44 age_48 age_52 age_56 age_60;
    MODEL CNORM; MAX 100; NGROUPS 4; ORDER 2 2 2 3 ;
RUN;

PROC TRAJ DATA=pool_traj OUT=OF_4 OUTPLOT=OP_4 OUTSTAT=OS_4 OUTEST=OE_4 ITDETAIL;
    ID id; VAR act_40 act_44 act_48 act_52 act_56 act_60; INDEP age_40 age_44 age_48 age_52 age_56 age_60;
    MODEL CNORM; MAX 100; NGROUPS 4; ORDER 1 2 2 3 ;
RUN;

PROC TRAJ DATA=pool_traj OUT=OF_4 OUTPLOT=OP_4 OUTSTAT=OS_4 OUTEST=OE_4 ITDETAIL;
    ID id; VAR act_40 act_44 act_48 act_52 act_56 act_60; INDEP age_40 age_44 age_48 age_52 age_56 age_60;
    MODEL CNORM; MAX 100; NGROUPS 4; ORDER 1 1 2 3 ;
RUN;

PROC TRAJ DATA=pool_traj OUT=OF_4 OUTPLOT=OP_4 OUTSTAT=OS_4 OUTEST=OE_4 ITDETAIL;
    ID id; VAR act_40 act_44 act_48 act_52 act_56 act_60; INDEP age_40 age_44 age_48 age_52 age_56 age_60;
    MODEL CNORM; MAX 100; NGROUPS 4; ORDER 1 1 1 3 ;
RUN;

PROC TRAJ DATA=pool_traj OUT=OF_4 OUTPLOT=OP_4 OUTSTAT=OS_4 OUTEST=OE_4 ITDETAIL;
    ID id; VAR act_40 act_44 act_48 act_52 act_56 act_60; INDEP age_40 age_44 age_48 age_52 age_56 age_60;
    MODEL CNORM; MAX 100; NGROUPS 4; ORDER 2 2 2 2 ;
RUN;

PROC TRAJ DATA=pool_traj OUT=OF_4 OUTPLOT=OP_4 OUTSTAT=OS_4 OUTEST=OE_4 ITDETAIL;
    ID id; VAR act_40 act_44 act_48 act_52 act_56 act_60; INDEP age_40 age_44 age_48 age_52 age_56 age_60;
    MODEL CNORM; MAX 100; NGROUPS 4; ORDER 1 2 2 2 ;
RUN;

PROC TRAJ DATA=pool_traj OUT=OF_4 OUTPLOT=OP_4 OUTSTAT=OS_4 OUTEST=OE_4 ITDETAIL;
    ID id; VAR act_40 act_44 act_48 act_52 act_56 act_60; INDEP age_40 age_44 age_48 age_52 age_56 age_60;
    MODEL CNORM; MAX 100; NGROUPS 4; ORDER 1 1 2 2 ;
RUN;

PROC TRAJ DATA=pool_traj OUT=OF_4 OUTPLOT=OP_4 OUTSTAT=OS_4 OUTEST=OE_4 ITDETAIL;
    ID id; VAR act_40 act_44 act_48 act_52 act_56 act_60; INDEP age_40 age_44 age_48 age_52 age_56 age_60;
    MODEL CNORM; MAX 100; NGROUPS 4; ORDER 1 1 1 2 ;
RUN;

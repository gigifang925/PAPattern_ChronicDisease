...
%include '/udd/hpzfa/review/PA/revision/nhs.doloop.sas';
%include '/udd/hpzfa/review/PA/revision/nhs2.doloop.sas';

data nhsdata;
set nhs1data nhs2data end=_end_;
...
proc sort data=nhsdata; by cohort &quantvar; run;
proc means data=nhsdata n nmiss median p25 p75;
     var &var;
     by cohort &quantvar;
...
data nhsdata; merge nhsdata median; by cohort &quantvar; run;
%mend;
...
proc printto print='OUTPUT_Main_Women' new;

%let cov1=white &phmsstatus_ cafh cvdfh dbfh &smkpy_ &alcc_ &aheiq_ &bmicat_ mvit  regaspa  regibuia  &husbedu_  &ladda_  &laddb_;
%let cov2=white &phmsstatus_ cafh cvdfh dbfh &smkpy_ &alcc_ &aheiq_          mvit  regaspa  regibuia  &husbedu_  &ladda_  &laddb_;

%mphreg9(data=nhsdata, event=chrv, qret=irt86 irt88 irt90 irt92 irt94 irt96 irt98 irt00 irt02 irt04 irt06 irt08 irt10 irt12 irt14 irt16 irt18,
         timevar=t86 t88 t90 t92 t94 t96 t98 t00 t02 t04 t06 t08 t10 t12 t14 t16 t18,
         id=id, labels=f,
         tvar=interval_b,
         agevar=agemos,
         strata=agemos interval_b, 
         cutoff=cutoff,

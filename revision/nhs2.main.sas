...
*call in outcome;
%include '/udd/hpzfa/review/PA/revision/nhs2.outcome.sas';

*call in derived aspirin and nsaids;
%include '/udd/hpzfa/review/PA/revision/asp_nhs2.sas';
...
* ------ EXPOSURES & Oth COVARIATES ------ *;
      ...
      %der8919 (keep=birthday height89 bmi18 race8905 mrace8905 eth8905 height agessmk
           ...
           %nur99(keep=wt99 mi99 db99 hbp99 str99 ang99 chol99 cabg99 husbe99 husbedu
                       cpreg99 preg99);
                       if wt99 = 0 then wt99=.;
                       if husbe99=1 or husbe99=2 then husbedu=1; 
	              else if husbe99=3 or husbe99=4 then husbedu=2;
	              else if husbe99=5 then husbedu=3;
 	              else if husbe99=6 or husbe99=. then husbedu=.;
                  run;
         
           %nur01(keep=wt01 sittv01 sleep01 mi01 db01 hbp01 str01 ang01 chol01 cabg01 ladda01 laddb01 ladda laddb       
                       depre01 depdr01 
                       marry01 divor01 widow01 nvmar01 separ01 q27pt01
                       alone01 husb01 afam01 othlv01 mchld01 q28pt01
                       cpreg01 preg01); 
                       if wt01 = 0 then wt01=.;
                       if ladda01=1 or ladda01=2 then ladda=0;
	              else if ladda01=3 or ladda01=4 or ladda01=5 then ladda=1;
                       else if ladda01=6 or ladda01=7 or ladda01=8 or ladda01=9 or ladda01=10 then ladda=2;
	              else if ladda01=11 or ladda01=. then ladda=.;
	              if laddb01=1 or laddb01=2 then laddb=0;
	              else if laddb01=3 or laddb01=4 or laddb01=5 then laddb=1;
                       else if laddb01=6 or laddb01=7 or laddb01=8 or laddb01=9 or laddb01=10 then laddb=2;
	              else if laddb01=11 or laddb01=. then laddb=.;
                  run;

%include '/udd/hpzfa/review/PA/revision/gformula/hpfs.main.sas'; 

data pre_pm;
     set base  end=_end_;
   
   array rtmnyr  {19}    rtmnyr86       rtmnyr86       rtmnyr88       rtmnyr90       rtmnyr92       rtmnyr94        rtmnyr96        rtmnyr98       rtmnyr00       rtmnyr02       rtmnyr04       rtmnyr06        rtmnyr08        rtmnyr10       rtmnyr12       rtmnyr14       rtmnyr16     rtmnyr18    cutoff; 
   ...
   array mar     {18}    marital86      marital86      marital88      marital90      marital92      marital94       marital96       marital98      marital00      marital02      marital04      marital06       marital08       marital10      marital12      marital14      marital16    marital18;   
   array bmi     {18}    bmi86          bmi86          bmi88          bmi90          bmi92          bmi94           bmi96           bmi98          bmi00          bmi02          bmi04          bmi06           bmi08           bmi10          bmi12          bmi14          bmi16        bmi18;
   array bmiv    {18}    bmi86v         bmi86v         bmi88v         bmi90v         bmi92v         bmi94v          bmi96v          bmi98v         bmi00v         bmi02v         bmi04v         bmi06v          bmi08v          bmi10v         bmi12v         bmi14v         bmi16v       bmi18v;
   array smok    {18}    smoke86        smoke86        smoke88        smoke90        smoke92        smoke94         smoke96         smoke98        smoke00        smoke02        smoke04        smoke06         smoke08         smoke10        smoke12        smoke14        smoke16      smoke18;
   array pkyr    {18}    pckyr86        pckyr86        pckyr88        pckyr90        pckyr92        pckyr94         pckyr96         pckyr98        pckyr00        pckyr02        pckyr04        pckyr06         pckyr08         pckyr10        pckyr12        pckyr14        pckyr16      pckyr18; 
   array cig     {18}    cgnm86         cgnm86         cgnm88         cgnm90         cgnm92         cgnm94          cgnm96          cgnm98         cgnm00         cgnm02         cgnm04         cgnm06          cgnm08          cgnm10         cgnm12         cgnm14         cgnm16       cgnm18;
   array alcon   {18}    alco86n        alco86n        alco86n        alco90n        alco90n        alco94n         alco94n         alco98n        alco98n        alco02n        alco02n        alco06n         alco06n         alco10n        alco10n        alco14n        alco14n      alco18n;  
   array alconv  {18}    alco86nv       alco86nv       alco86nv       alco90nv       alco90nv       alco94nv        alco94nv        alco98nv       alco98nv       alco02nv       alco02nv       alco06nv        alco06nv        alco10nv       alco10nv       alco14nv       alco14nv     alco18nv;  
   array ahei    {18}    nAHEI86a       nAHEI86a       nAHEI86a       nAHEI90a       nAHEI90a       nAHEI94a        nAHEI94a        nAHEI98a       nAHEI98a       nAHEI02a       nAHEI02a       nAHEI06a        nAHEI06a        nAHEI10a       nAHEI10a       nAHEI14a       nAHEI14a     nAHEI14a;  
   array aheiv   {18}    ahei86v        ahei86v        ahei86v        ahei90v        ahei90v        ahei94v         ahei94v         ahei98v        ahei98v        ahei02v        ahei02v        ahei06v         ahei06v         ahei10v        ahei10v        ahei14v        ahei14v      ahei14v;  
   array aspa    {18}    regaspre86     regaspre86     regaspre88     regaspre90     regaspre92     regaspre94      regaspre96      regaspre98     regaspre00     regaspre02     regaspre04     regaspre06      regaspre08      regaspre10     regaspre12     regaspre14     regaspre16   regaspre16;
   array ibuia   {18}    regibui86      regibui86      regibui88      regibui90      regibui92      regibui94       regibui96       regibui98      regibui00      regibui02      regibui04      regibui06       regibui08       regibui10      regibui12      regibui14      regibui16    regibui16;   
   array mvyn    {18}    mvt86          mvt86          mvt88          mvt90          mvt92          mvt94           mvt96           mvt98          mvt00          mvt02          mvt04          mvt06           mvt08           mvt10          mvt12          mvt14          mvt14        mvt18;

   array actm    {18}    act86          act86          act88          act90          act92          act94           act96           act98          act00          act02          act04          act06           act08           act10          act12          act14          act16        act16;
   array actmv   {18}    act86v         act86v         act88v         act90v         act92v         act94v          act96v          act98v         act00v         act02v         act04v         act06v          act08v          act10v         act12v         act14v         act16v       act16v;      
   ...
   array actbin  {18}    att86          att86          att88          att90          att92          att94           att96           att98          att00          att02          att04          att06           att08           att10          att12          att14          att16        att16;
   ...
   /*
   array fhxcanc {18}    cafh86         cafh86         cafh86         cafh90         cafh92         cafh92          cafh96          cafh96         cafh96         cafh96         cafh96         cafh96          cafh08          cafh08         cafh12         cafh12         cafh12       cafh12;
   array fhxcvd  {18}    cvdfh86        cvdfh86        cvdfh86        cvdfh86        cvdfh86        cvdfh86         cvdfh96         cvdfh96        cvdfh96        cvdfh96        cvdfh96        cvdfh96         cvdfh96         cvdfh96        cvdfh96        cvdfh96        cvdfh96      cvdfh96;
   array fhxdb   {18}    dbfh87         dbfh87         dbfh87         dbfh90         dbfh92         dbfh92          dbfh92          dbfh92         dbfh92         dbfh92         dbfh92         dbfh92          dbfh08          dbfh08         dbfh08         dbfh08         dbfh08       dbfh08;
   array chol    {18}    chol86         chol86         chol88         chol90         chol92         chol94          chol96          chol98         chol00         chol02         chol04         chol06          chol08          chol10         chol12         chol14         chol16       chol18;
   array hbp     {18}    hbp86          hbp86          hbp88          hbp90          hbp92          hbp94           hbp96           hbp98          hbp00          hbp02          hbp04          hbp06           hbp08           hbp10          hbp12          hbp14          hbp16        hbp18;
   array repang  {18}    ang86          ang86          ang88          ang90          ang92          ang94           ang96           ang98          ang00          ang02          ang04          ang06           ang08           ang10          ang12          ang14          ang16        ang18;     
   array repcabg {18}    cabg86         cabg86         cabg88         cabg90         cabg92         cabg94          cabg96          cabg98         cabg00         cabg02         cabg04         cabg06          cabg08          cabg10         cabg12         cabg14         cabg16       cabg18; 
   */
...
*************************************************************************/
 ...
 /** check **/    
   do i=2 to DIM(irt)-1; 
      if (irt{i}<(985+24*i) | irt{i}>=(1009+24*i)) then irt{i}=985+24*i;    /*1986 - 1033*/
   end;  
...
postmnp=0; postmnp_l1=0; /*male premenopausal*/  
hor=0; hor_l1=0; /*no pmh use*/
if mvt86=. then mvt86=0;
if pckyr86<=5 then pkyr86=0; else pkyr86=1; 
...
keep 
 ...
 bmicon   bmicat     alcocon    alcc      aheicon     smkst      smkpy      packy     mvit      
          &bmicat_              &alcc_                &smkst_    &smkpy_                                                         
 ...
 age86  obes86  regaspre86  regibui86  mvt86  pkyr86  alco86n  nAHEI86a
; 
run;
...
proc means n nmiss mean median min max; 
     var agecon      actcon
         ...
         age86  obes86  regaspre86  regibui86  mvt86  pkyr86  alco86n  nAHEI86a
	/*age_bs  bmi_bs  aspirin_bs  ibui_bs    mvt_bs  pkyr_bs  alco_bs  ahei_bs*/
;
run;

data g_fm.hpfs_main; set hpfsdata; 
run; 

/*
proc datasets;
delete base  pre_pm  hpfsdata;
run;
*/

...
*call in outcome;
%include '/udd/hpzfa/review/PA/revision/gformula/nhs.outcome.sas';

*call in derived aspirin and nsaids;
%include '/udd/hpzfa/review/PA/revision/gformula/asp_nhs.sas';
...
* ------ EXPOSURES & Oth COVARIATES ------ *;
    ...
    %der7620(keep=mobf yobf race9204 white bmiage18 ageb1
                  ...
                  if irt20 ne . and irt20 ne 0 then irt18=1422;
                  run;
    ...
    %nur92(keep=wt92 db92 hbp92 chol92 mi92 ang92 str92 cabg92 marry92 divor92 separ92 widow92 nvrmr92 marital92
    ...
    %nur00(keep=wt00 db00 hbp00 chol00 mi00 ang00 str00 cabg00 marry00 divor00 widow00 separ00 nvmar00 q31pt00 marital00
    ...
    *******************************************;
    ...
    merge der7620(in=mst) nhs_outcome meds8020 supp8020 act8614 familyhis nhs_asp ahei2010_8420
     ...
     if first.id and mst then exrec=0; 
      ...
      /** check **/
      array irt    {*} irt86    irt88    irt90    irt92    irt94    irt96    irt98    irt00    irt02    irt04    irt06     irt08    irt10    irt12    irt14    irt16;
      array anoirt {*} noirt86  noirt88  noirt90  noirt92  noirt94  noirt96  noirt98  noirt00  noirt02  noirt04  noirt06   noirt08  noirt10  noirt12  noirt14  noirt16;

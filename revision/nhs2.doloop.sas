%include '/udd/hpzfa/review/PA/revision/nhs2.main.sas'; 
...
/* SES */
%indic3(vbl=husbedu, prefix=husbedu, min=1, max=3, reflev=1, missing=., usemiss=1,
                   label1='=<hs',
                   label2='college',
                   label3='grad');
%indic3(vbl=ladda, prefix=ladda, min=0, max=2, reflev=0, missing=., usemiss=1,
                   label1='1-2 rung',
                   label2='3-5 rung',
                   label3='6-10 rung');
%indic3(vbl=laddb, prefix=laddb, min=0, max=2, reflev=0, missing=., usemiss=1,
                   label1='1-2 rung',
                   label2='3-5 rung',
                   label3='6-10 rung');
...
/*
proc printto print='OUTPUT_Descrip_NHS2' new;

proc freq;
     table white  smkst  smkpy  alcc  bmicat  actcat   phmsstatus  aheiq
           regaspa  regibuia  mvit  cafh  dbfh  cvdfh  hchol  htn  angina  cabg
           chrv  husbedu  ladda  laddb         
;
run;
